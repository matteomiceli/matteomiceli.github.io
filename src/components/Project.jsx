      ...
      <div className="flex flex-col-reverse items-center md:flex-row">
        <div className="sm:w-5/6 mt-0 md:mt-10 md:w-1/2 md:pr-10">
          <div className="flex flex-col xl:flex-row">
            <p className="mt-4 text-teal text-lg font-bold">{project.type}</p>
            <div className="mx-2 mt-4 hidden xl:block">|</div>
            <p className="xl:ml-0 xl:mt-4 text-lg font-bold">{project.role}</p>
          </div>
          ...
          <div className="mt-24 buttons flex">
            {/* Only render live site for Minerva */}
            {project.name === "Minerva" && (
              <a target="_blank" href={project.links.website}>
                <button className="flex justify-center font-semibold items-center mr-8 w-32 bg-gradient-to-br p-2 nav-home bg-scale4 from-blue to-teal rounded transition-all duration-300 text-bg-dark">
                  <img
                    className="w-4 mr-2"
                    src="/icons/web.svg"
                    alt="web icon"
            ...
            <a target="_blank" href={project.links.github}>
              <button className="flex justify-center items-center w-32 border-2 border-white p-1.5 rounded hover:bg-white hover:bg-opacity-10 transition-all duration-300">
                <img
                  className="w-4 mr-2"
